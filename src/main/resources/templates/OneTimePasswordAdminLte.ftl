	...
	<div class="form-cell form-group <#if error??>has-error</#if>" ${elementMetaData!}>
		...
		<div class="input-group">
            ...
            <span class="input-group-btn">
                <button type="button" class="btn btn-primary" id="${elementId!}-generate-otp" name="${elementParamName!}-generate-otp">${element.properties.generateTokenButtonLabel!}</button>
            </span>
       </div>
